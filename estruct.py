...
datasink8 = glueContext.write_dynamic_frame.from_options(frame = dif, connection_type = "s3", connection_options = {"path": "s3://imobiliario/parquetveiculos"}, format = "parquet", transformation_ctx = "datasink8")
